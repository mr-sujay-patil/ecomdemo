...
class LoggingStackConfigTest {
    ...
    private static final Path ALLOY = Path.of("docker/alloy/config.alloy");
    private static final Path LOKI = Path.of("docker/loki/loki.yaml");
    private static final Path DATASOURCE = Path.of("docker/grafana/provisioning/datasources/loki.yml");
    private static final Path DASHBOARD = Path.of("docker/grafana/dashboards/ecomdemo-logs.json");
