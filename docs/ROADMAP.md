...
| 20c | [Microservices Split — catalog-service](phases/phase-20-microservices.md) | **catalog-service** extracted, taking `cache` with it | `feature/phase-20c-catalog-service` | ✅ |
| 20d | [Microservices Split — the rest](phases/phase-20d-plan.md) | **customer + notification**; order-service is the residue. Tags `phase-20-complete` | `feature/phase-20d-customer-service` | 🔵 |
